          ...
          <div className="container">
            <div className="row">
              ...
              <div className="temp-head mt-4">
                <h1 className={`${fnts}`}>Pets World</h1>
                <h3 className={`${fnts}`}>Welcome to Pets World  Your Pet’s Favorite Place!</h3>
                <p className={`${fnts}`}>At Pets World, we provide everything your pet needs to stay happy and healthy—whether it’s a playful pup, a curious cat, a chirping bird, or a swimming companion!</p>
              </div>
