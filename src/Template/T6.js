...
import logo from "../Assest/Images/t6/logo.png";
...
const T6 = ({ theme = "template-bg6", page = "hm-t6", bckgnd = "back-g-t6", fnts = "t6" }) => {

  
  const headerContent = {
    heading: "Your Trusted Gadget Repair Partner",
    // subHeading: "Unlock Your Learning Potential!",
    description: "Quick, Reliable Gadget RepairsYour one-stop solution for phone, tablet, and laptop repairs.",
    buttonText: "Book a Call",
    buttonLink: "/contact",
    heading2:"Business addres",
          ...
          <div className="container">
            <div className="row">
              <div className={`logo pt-3 ${fnts}`}>
                 <div className={`side-head  ${fnts}`}>
                <h1 className={`${fnts}`}>
                   Mobile &
    Laptop Repair
                </h1>
            </div>
            <div className={`logo-img ${fnts}`}>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="info-temp mt-2">
                   <h1 className={`${fnts}`}>{headerContent.heading2}</h1>
